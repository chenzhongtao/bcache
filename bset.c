 ...
 */
static unsigned int __to_inorder(unsigned int j, unsigned int size, unsigned int extra)
{
...
static unsigned int __inorder_to_tree(unsigned int j, unsigned int size, unsigned int extra)
{
	unsigned int shift;
...
static struct bkey *cacheline_to_bkey(struct bset_tree *t, unsigned int cacheline,
				      unsigned int offset)
{
...
int bch_bset_sort_state_init(struct bset_sort_state *state, unsigned int page_order)
{
